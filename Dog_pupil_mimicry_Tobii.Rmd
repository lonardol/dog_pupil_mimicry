...
prepr.pupil.data<-full_join(prepr.pupil.data1, prepr.pupil.data2) %>% 
...
```
```{r}
as.data.frame(anova(mm1.tobii.null, mm1.tobii.full, test="Chisq")) #full-null model comparison is significant (Chisq.=111.64, Df=20, P<.001)	
```
