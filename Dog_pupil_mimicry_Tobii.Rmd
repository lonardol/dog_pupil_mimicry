...
prepr.pupil.data <- prepr.pupil.data4 %>%
  ...
  ungroup() %>% 
  filter(Time > baseline.end) ##Only keep 4 seconds from end baseline 
```
# LL: 28/05/2024: before fitting the model again, try to use Roger's function fe.re.tab on prepr.pupil.data, to get rid of NAs
```{r}
#prepare data for modelling
source("./functions/diagnostic_fcns.r")
xx.fe.re=fe.re.tab(fe.model="log.cort~rank*daytime+fai+sex",
re="(1|subj)+(1|group)+(1|gr.date)", data=xdata)
```
...
source("./functions/diagnostic_fcns.r") #LL:add folder with functions to the repository
...
full.stab_mm1.tobii.full.int=glmm.model.stab(model.res=mm1.tobii.full.int, contr=NULL, para=F, data=prepr.pupil.data)
m.stab.plot(full.stab_mm1.tobii.full.int$summary[, -1])
full.stab_mm1.tobii.full.int$summary
