...
prepr.pupil.data.barplot <- prepr.pupil.data4 %>%
  ...
  summarise(mean_base_corrected_pupil=mean(pupil.base.corrected, na.rm=TRUE), sd=sd(pupil.base.corrected, na.rm=TRUE)) %>% 
...
barplot<-ggplot(prepr.pupil.data.barplot, aes(x = Stim_species, y = mean_base_corrected_pupil, fill = Stim_pupil_movement)) +
 ...
 # geom_point(aes(y = mean_base_corrected_pupil, color = Stim_pupil_movement), 
  ...
  labs(x = "Stim Species", y = "Mean Base Corrected Pupil") +
  theme_minimal() +
...
ggsave(barplot, filename = "graphs/barplot.plot.png", height = 5, width = 8, scale = 0.7, dpi=1200)
```
