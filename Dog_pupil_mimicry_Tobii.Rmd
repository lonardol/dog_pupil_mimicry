...
all.data<-
  read_tsv("./data/Dog_pupil_mimicry_08_03_2024_AOI_based_gazefilterfixation_incl_glances.tsv") %>% 
  mutate(Recording=as.factor(Recording)) %>% 
  mutate(Participant=as.factor(Participant)) %>% 
  mutate(Timeline=as.factor(Timeline)) %>% 
  filter(Recording!="Recording48" & Recording!="Recording55" & Recording!="Recording56" & Recording!="Recording57" & Recording!="Recording58" & Recording!="Recording60" & Recording!="Recording71" & Recording!="Recording72" & Recording!="Recording74" & Recording!="Recording78" & Recording!="Recording80" & Recording!="Recording81" & Recording!="Recording107" & Recording!="Recording119" & Recording!="Recording131" & Recording!="Recording156" & Recording!="Recording158" & Recording!="Recording160" & Recording!="Recording161" & Recording!="Recording165" &  Recording!="Recording170" & Recording!="Recording172" & Recording!="Recording175" & Recording!="Recording177" & Recording!="Recording180" &  Recording!="Recording231" & Recording!="Recording251" & Recording!="Recording259" & Recording!="Recording260") # Sessions to be excluded (if not already excluded from project) as they were collected again with lower data loss
```
